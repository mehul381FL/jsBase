...
var xmlToJson = (function () {
    ...
    if ( self.convertDataType === false) return val;
    ...
    // Expose the API
   module.exports.parseXML =  function (xml,convertStringToPrimitiveDataType) {
    convertStringToPrimitiveDataType = convertStringToPrimitiveDataType || false;
    self.convertDataType = convertStringToPrimitiveDataType;
